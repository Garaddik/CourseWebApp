	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content">
				<form:form action="addstudent" method="post" class="student"
					commandName="student">
					<!--Table-->
					<div class="row">
						<div class="col-lg-12">
							<div class="panel filterable">
								<div class="panel-heading">
									<h3 class="panel-title">
										<i class="ti-move"></i> Student Information
									</h3>
								</div>
								<c:if test="${requestScope.error ne null}">
									<label style="color: #ff0000;"> ${requestScope.error}</label>
								</c:if>
												...
												<div class="form-group">
													...
													<div class="input-group">
														...
														<form:textarea path="address" class="form-control"
															id="address" title="address" size="50" />
													</div>
													<!-- /.input group -->
												</div>
											...
											<div class="panel-body">
												<div class="flatbuttons_small">
													<ul>
														...
														<li>
															<button
																class="button button-rounded button-action-flat hvr-float-shadow">
																Add</button>
														</li>
